...
@export_dir var scenes_folder: String = "res://Scenes/Passive Items/"

## The file to save JSON output to
@export_file("*.json") var output_file: String = "res://Data/item_pool.json"
...
func _run() -> void:
	...
	print("✅ Item pool saved to:", output_file)
